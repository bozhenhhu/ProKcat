...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', default='/usr/data/DLTKcat/data/my_performance/model_latentdim=40_outlayer=4epoch4_rmsetest=0.8719_rmsedev=0.7126.pth')
    parser.add_argument('--param_dict_pkl', default='/usr/data/DLTKcat/data/hyparams/param_2.pkl')
    parser.add_argument('--input', default='/usr/data/DLTKcat/data/test_data.csv')
    parser.add_argument('--output', default = '/usr/data/DLTKcat/data/my_pred')
    ...
    # # Prep input
    # if os.path.isdir('/usr/data/DLTKcat/data/pred/temp'):
    #     os.system('rm -rf /usr/data/DLTKcat/data/pred/temp')
        
    # os.system('mkdir /usr/data/DLTKcat/data/pred/temp')
    # os.system('python gen_features.py --data '+str(args.input)+' --output /usr/data/DLTKcat/data/pred/temp/ --has_dict True \
    #                                                                           --has_label '+ str(args.has_label)  )
    data_input = load_data('/usr/data/DLTKcat/data/', has_label, 'test')
    ...
    data.to_csv(  str( args.output ) +'test.csv' ,index=None )
