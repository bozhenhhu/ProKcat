...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str , default='../data/train_features_esm_seq')
    ...
    # get_esm_seq_features( data_path, output_path, radius, ngram, has_dict, dict_path, has_label )
