...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='/usr/data/DLTKcat/data/test_data.csv')
    parser.add_argument('--output', type=str , default='/usr/data/DLTKcat/data/test_features_esm')
    parser.add_argument('--radius', default = 2, type=int )
    parser.add_argument('--ngram', default = 3, type=int )
    parser.add_argument('--has_dict', type=str, choices=['False','True'], default = 'True')
    parser.add_argument('--dict_path', type=str, default = '/usr/data/DLTKcat/data/dict')
