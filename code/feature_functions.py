...
def get_esm_features( data_path, output_path, radius, ngram, has_dict, dict_path, has_label ):
    ...
    for index in range(len(data)):
        ...
        # sequence_representation = token_representations[0][1 : batch_lens - 1]
        proteins.append(token_representations.cpu().numpy())
...
def get_esm_seq_features( data_path, output_path, radius, ngram, has_dict, dict_path, has_label ):
